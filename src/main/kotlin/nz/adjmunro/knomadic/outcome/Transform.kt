 ...
 */
@KnomadicDsl
public suspend inline fun <In : Any, Out : Any, ErrorIn : Any, ErrorOut : Any> Outcome<In, ErrorIn>.fold(
 ...
 */
@KnomadicDsl
public suspend inline fun <In : Any, Out : Any, ErrorIn : Any, ErrorOut : Any> Outcome<In, ErrorIn>.flatFold(
 ...
 */
@KnomadicDsl
public suspend inline infix fun <In : Any, Out : Any, Error : Any> Outcome<In, Error>.mapSuccess(
 ...
 */
@KnomadicDsl
public suspend inline infix fun <In : Any, Out : Any, Error : Any> Outcome<In, Error>.flatMapSuccess(
 ...
 */
@KnomadicDsl
public suspend inline infix fun <Ok : Any, ErrorIn : Any, ErrorOut : Any> Outcome<Ok, ErrorIn>.mapFailure(
 ...
 */
@KnomadicDsl
public suspend inline infix fun <Ok : Any, ErrorIn : Any, ErrorOut : Any> Outcome<Ok, ErrorIn>.flatMapFailure(
