...
@NomadicDsl
suspend inline infix fun <Ok : Any, Error : Any> Outcome<Ok, Error>.coerceToFailure(
...
@OptIn(ExperimentalContracts::class)
@NomadicDsl
suspend inline infix fun <Ok : Any, Error : Any> Outcome<Ok, Error>.coerceToSuccess(
 ...
 */
@NomadicDsl
fun <Ancestor, Ok, Error> Outcome<Ok, Error>.collapseToAncestor(): Ancestor where
...
@OptIn(ExperimentalContracts::class)
@NomadicDsl
suspend inline fun <Ok, Error, Output> Outcome<Ok, Error>.collapseFold(
 ...
 */
@NomadicDsl
fun <Ok, EmbeddedError, OuterError, AncestorError> Outcome<Outcome<Ok, EmbeddedError>, OuterError>.flattenNestedSuccess(): Outcome<Ok, AncestorError> where
 ...
 */
@NomadicDsl
fun <OuterOk, EmbeddedOk, Error, AncestorOk> Outcome<OuterOk, Outcome<EmbeddedOk, Error>>.flattenNestedFailure(): Outcome<AncestorOk, Error> where
 ...
 */
@NomadicDsl
fun <SuccessOk, SuccessError, FailureOk, FailureError, AncestorOk, AncestorError> Outcome<Outcome<SuccessOk, SuccessError>, Outcome<FailureOk, FailureError>>.flattenNestedBoth(): Outcome<AncestorOk, AncestorError> where
